    ...
    return `<article class="group overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
      ...
      <div class="p-4">
        ...
        <div class="mt-3 flex items-center justify-between gap-2">
          <span class="badge ${product.owner.level === "gold" ? "bg-amber-100 text-amber-700" : product.owner.level === "silver" ? "bg-slate-100 text-slate-700" : "bg-orange-100 text-orange-700"}">${product.owner.level[0].toUpperCase() + product.owner.level.slice(1)} Owner</span>
