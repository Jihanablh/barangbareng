(function () {
  ...
  function orderActions(status, item, transactionId, reviewed) {
    ...
    if (status === "FULLY_PAID") return `<button class="btn-primary mt-5 w-full rounded-2xl px-5 py-3" data-nav="tracking">Mulai Tracking Serah Terima</button><button class="btn-secondary mt-3 w-full rounded-2xl px-5 py-3" data-nav="qr-handover">Lihat Kode Serah Terima</button>`;
    if (status === "READY_FOR_PICKUP") return `<button class="btn-primary mt-5 w-full rounded-2xl px-5 py-3" data-nav="tracking">Buka Tracking Serah Terima</button><button class="btn-secondary mt-3 w-full rounded-2xl px-5 py-3" data-nav="qr-handover">Tampilkan Kode Serah Terima</button>`;
    if (status === "RENTED") return `<button class="btn-primary mt-5 w-full rounded-2xl px-5 py-3" data-nav="tracking">Lanjutkan Pengembalian</button><button class="btn-secondary mt-3 w-full rounded-2xl px-5 py-3" data-nav="chat">Chat Pemilik</button>`;
